<div class="col-2">
    <div class="list-group">
        ...
        <a class="list-group-item text-primary ms-5" href="<?php echo base_url("/tasks/") ?>">Aufgaben</a>
        <a class="list-group-item text-primary ms-5" href="<?php echo base_url("/persons/") ?>">Personen</a>
    </div>
</div>
